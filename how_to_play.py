...
The computer will generate a word randomly from a predefined list.
...
Guess Letters: Take turns guessing letters that you think might be in the word. 
You can usually type your guesses into a text box provided by the game. 
Start with common letters like vowels (a, e, i, o, u) or frequently used consonants (like s, t, n, r).
...
Keep Guessing: Continue guessing letters one by one until you either guess the word correctly or make too many incorrect guesses, 
resulting in the Hangman being fully drawn.

Winning and Losing: If you guess the word correctly before the Hangman is fully drawn, you win! 
